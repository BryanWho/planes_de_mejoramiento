...
\begin{document}
	...
	\textbf{D1:} Usa el Teorema de Pitágoras para la resolución de triángulos rectángulos
	
	\textbf{D2:} Usa las razones trigonométricas para la resolución de triángulos rectángulos
	
	\textbf{D3:} Modela situaciones de la vida real usando razones trigonométricas y teorema de Pitágoras
	
	\textbf{D4:} Reconoce las identidades pitágoricas con ayuda de la circunferencia unitaria
	
	\textbf{D5:} Usa las identitades trigonométricas de ángulos dobles.
	
	\textbf{D6:} Resuelve ecuaciones trigonométricas con ayuda de las identidades trigonométricas.
	
	\textbf{D7:} Usa el teorema del Seno para la resolución de triángulos oblicuángulos
	
	\textbf{D8:} Usa el teorema del Coseno para la resolución de triángulos oblicuángulos
	
	\textbf{D9:} Modela situaciones de la vida real usando el teorema del Seno y del Coseno.
	
	\textbf{D10:} Encuentra el área de un triángulo aplicando el teorema de Herón
	...
	\begin{itemize}
		\item \textbf{Desempeños trigonometría aplicada} (D1, D2, D3, D7, D8, D9, D10)
		
		\begin{figure}[h]
			\includegraphics[scale=0.5]{triangulo_rectangulo.png}
		\end{figure}
		\newpage
		\item \textbf{Desempeños trigonometría analítica} (D4, D5, D6)
		\begin{figure}[h]
